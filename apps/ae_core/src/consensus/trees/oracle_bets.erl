...
%% Each account has a tree of oracle bets.
%% Oracle bets are not transferable.
%% Once an oracle is settled,
%% the bets in it can be converted to shares.

%% true, false, and bad are the 3 types of shares
%% that can be purchased from an oracle
...
new(OracleID, True, False, Bad) ->
    #bet{id = OracleID, true = True, false = False, bad = Bad}.
